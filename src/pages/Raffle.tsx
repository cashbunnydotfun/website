        ...
        <Toaster />
            ...
            >{isMobile ? (
                <>
                 ...
                 <GridItem colSpan={1} rowSpan={1} p={4} w="450px"  mt={bunnyBalance > 0 ? "-40px" : isConnected ? "-60px" : "-40px"}>
                ...
                <GridItem colSpan={1} rowSpan={1} p={4} ml={50}  mt={bunnyBalance > 0 ? "-40px" : isConnected ? "-60px" : "-40px"}>
